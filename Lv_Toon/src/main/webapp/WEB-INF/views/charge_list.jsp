		...
		<div id="my_page_body">
			<div>
				<div style="width:90%; height:300px; margin:10px auto; border:1px solid #D8D8D8;">
					<div style="width:80%; height:70%; margin:auto; border-bottom:1px solid #D8D8D8;">
						<p>코인 내역</p>
						<p><a href="charge_list" style="color:#817EE4;">적립 내역</a></p>
			...
			<div>
				<div style="width:100%; height:50px; margin-top:10px;">
					<span style="margin-left:10px; font-size:20px;">적립내역</span>
				<div style="width:100%; height:100%; margin-top:30px;">
					<table id="charge_table">
						...
						<c:forEach var="chlist" items="${chlist }">
							<tr>
								<td>${chlist.charge_date }</td>
								<td>
									<span style="font-size:15px; font-weight:bold;">
									<fmt:formatNumber pattern="##,###" value="${chlist.charge_coin }"/>
									</span>C
								</td>
								<td>
									<span style="font-size:15px; font-weight:bold;">
									<fmt:formatNumber pattern="##,###" value="${chlist.charge_price }"/>
									</span>원
								</td>
								<td>
									<c:if test="${chlist.charge_method=='card' }">
										카드결제
									</c:if>
								</td>
								<td>??</td>
