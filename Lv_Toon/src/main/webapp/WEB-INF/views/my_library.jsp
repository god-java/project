		...
		<div id="my_page_body">
			<div>
				<div style="width:90%; height:300px; margin:10px auto; border:1px solid #D8D8D8;">
					<div style="width:80%; height:70%; margin:auto; border-bottom:1px solid #D8D8D8;">
						...
						<p><a href="#" style="color:#817EE4;">내서재</a></p>
						<p><a href="#">찜목록</a></p>
					</div>
			...
			<div>
				<div style="width:100%; height:50px; margin-top:10px;">
					<span style="margin-left:10px; font-size:20px;">내서재</span>
				</div>
					...
					<c:forEach var="llist" items="${llist }">
						<div style="width:200px; height:300px; margin-left:3px; margin-top:10px; display:inline-block;">
							<div style="width:100%; height:200px;">
								<a href="episode_page?toon_num=${llist.toon_num }">
									<img src="resources/toon_main_img/${llist.main_image }" style="width:100%; height:100%">
								</a>
							</div>
							<div style="width:100%; height:30px; line-height:30px">
								<a href="episode_page?toon_num=${llist.toon_num }">
									<span style="font-weight:bolder; font-size:15px; color:black;">${llist.toon_title }</span>
								</a>
							</div>
							<div style="width:100%; height:20px; line-height:20px;">
								<a href="episode_page?toon_num=${llist.toon_num }">
									<span>${llist.cate_name }</span>
								</a>
							</div>
							<div style="width:100%; height:50px; line-height:50px; text-align:center;">
								<button class="next_ep_btn" param="${llist.toon_num }" param2="${llist.ep_num }" style="width:95%; height:30px; font-size:12px; font-weight:bold; margin-top:10px; background:white; border:1px solid #D8D8D8;">${llist.ep_num+1 }화 이어보기</button>
							</div>
						</div>
					</c:forEach>	
